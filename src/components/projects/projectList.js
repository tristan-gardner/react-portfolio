...
},
{
  ...
  text: `I worked with Berkeley's Strawberry Creek monitors to prototype an oil detector. Using the YOLO ML package, I trained a model that could detect the presence of gasoline on water.
    ...
    For images of quality 50x42 pixels, the model was 96% accurate. Code is available <a href="https://github.com/tristan-gardner/OilDetector">here</a>.
...
},
{
  ...
  text: `This was my first project getting into robotics. It uses an Arduino controller to read inputs from two soil moisture sensors. When it decides the soil is dry for a given plant, it moves the hose into the corresponding positions and pumps water.
    ...
    The wiring diagram comes from Tinkercad, which does not have every hardware piece, so some substitutions are made (e.g., the pump is shown as a DC motor). The full diagram can be found <a href="https://www.tinkercad.com/things/iUfKlWaL1I4?sharecode=uOX0T7HsVTXXm5GdxWj3Niw0dW8fV_me2L-ZcklGWy0" target="_blank">here</a>.
...
},
{
  ...
  text: `Using a <a href="https://www.parts-express.com/Dayton-Audio-DAEX25FHE-4-Framed-High-Efficiency-25mm-Exciter-295-224?quantity=1">Dayton audio exciter</a>, a <a href="https://www.parts-express.com/PE3W-BT-Rechargeable-Portable-3W-Bluetooth-Amplifier-320-630?quantity=1">Bluetooth amplifier</a>, and some fasteners, I turned my old snowboard into a speaker!
...
},
{
  ...
  text: `I built a <a href="https://github.com/tristan-gardner/slackronym">custom Slack bot</a> that helps define and look up company-specific lingo. Similar bots exist on the market, but if they store the data, it's in their system, which many companies are not okay with, given they may use it to store info about core features or upcoming products.
    ...
    Extensions - Make a constantly hosted version (Slack has a`
},
]
